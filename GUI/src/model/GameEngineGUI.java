...
public class GameEngineGUI implements GameEngine {
	...
	public void spin(int initialDelay, int finalDelay, int delayIncrement) {
		Runnable r = new GameEngineThread(this, initialDelay, finalDelay, delayIncrement);
		new Thread(r).start();
	}
	...
	public ArrayList<GameEngineCallback> getCallbacks() {
		// TODO Auto-generated method stub
		return callbacks;
	}
